    ...
    <div className="flex justify-between items-center mb-7 w-full">
      <div className="flex justify-between items-center gap-5">
        ...
        <div className="relative">
          <input
            type="search"
            className="pl-10 pr-4 py-2 w-50 md:w-60 border-2 border-gray-400 bg-white rounded-lg focus:outline-none focus:border-blue-500"
          />
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="font-semibold">Zeshan</span>
          </div>
        </div>
        <Link href="/settings">
          <Settings className="w-4 h-4 text-gray-500" size={24} />
        </Link>
      </div>
    </div>
  );
